...
consistently low ranking motifs. A selection of the results is visualized in Figure 3C. The full results are available as Supplementary File S1 and on Zenodo [@doi:10.5281/zenodo.1491482].
...
role in myeloid lineage commitment [@pmid:9694804]. The CEBP family members are important for monocytes and granulocytic cells [@doi:10.1038/sj.onc.1210764], and show a high motif activity in neutrophils and monocytes. Other strong motifs include RUNX for T cells and NK cells, GATA1 for erythroid cells (Fig. 3C). 
