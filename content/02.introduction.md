...
We previously published GimmeMotifs, a *de novo* ChIP-seq motif discovery pipeline [@10.1093/bioinformatics/btq636]. Here, we present a new and updated version of the GimmeMotifs software. Compared to the previous version, it now contains a whole range of Python modules and command-line tools to provide an comprehensive framework for transcription factor motif analysis. Amongst other possibilities it can be used to perfom *de novo* motif analysis, cluster and visualize motifs and to calculate enrichment statistics.
